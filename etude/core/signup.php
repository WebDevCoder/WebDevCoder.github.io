        ...
        <section class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="/core/signup.php">Регистрация</a></li>
                </ul>
            </div>
        </section>
        <section class="about-us">
            <div class="container">
                <h2 class="g-section-title">Регистрация</h2>
                <form action="/core/signup.php" class="registration__form" method="post">
                    <?php
                    if(isset($data['do_signup']));
                    {
                        ...
                        if( empty($errors))
                        {
                            ...
                            R::store($user);
                            echo '<div id="noerrors">Вы успешно зарегестрированы</div>';
                            header('location: /');
                        }else
                        {
                    ...
                    <div class="register-line">
                        <p class="label-register"><strong>Ваш Логин</strong></p>
                        <input class="g-input g-input-registr" type="text" name="login" value="<?php echo @$data['login']; ?>">
                    </div>
                    <div class="register-line">
                        <p class="label-register"><strong>Ваш Email</strong></p>
                        <input class="g-input g-input-registr" type="email" name="email" value="<?php echo @$data['email']; ?>">
                    </div>
                    <div class="register-line">
                        <p class="label-register"><strong>Ваш Пароль</strong></p>
                        <input class="g-input g-input-registr" type="password" name="password" value="<?php echo @$data['password']; ?>">
                    </div>
                    <div class="register-line">
                        <p class="label-register"><strong>Повторите Пароль</strong></p>
                        <input class="g-input g-input-registr" type="password" name="password_2" value="<?php echo @$data['password_2']; ?>">
                    </div>
                    <button type="submit" class="g-btn g-btn-registration g-btn_rewiews" name="do_signup">Зарегистрироваться</button>
                </form>
            </div>
        </section>
    </div>
