        ...
        <section class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="/core/signup.php">Авторизация</a></li>
                </ul>
            </div>
        </section>
        <section class="about-us">
            <div class="container">
                <h2 class="g-section-title">Авторизация</h2>
                <form action="/core/login.php" class="registration__form" method="post">
                    <?php
                    if(isset($data['do_login']));
                    {
                        ...
                        if($user){
                            if( password_verify($data['password'], $user->password)){
                                ...
                                echo '<div id="noerrors">Вы Авторизованы</div>';
                            }else
                            {
                    ...
                    <div class="register-line">
                        <p class="label-register"><strong>Логин</strong></p>
                        <input class="g-input g-input-registr" type="text" name="login" value="<?php echo @$data['login']; ?>">
                    </div>
                    <div class="register-line">
                        <p class="label-register"><strong>Пароль</strong></p>
                        <input class="g-input g-input-registr" type="password" name="password" value="<?php echo @$data['password']; ?>">
                    </div>
                    <button type="submit" class="g-btn g-btn-registration g-btn_rewiews" name="do_login">Войти</button>
                </form>
            </div>
        </section>
    </div>
