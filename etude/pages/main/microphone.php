        ...
        <section class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="microphone.php">Микрофоны</a></li>
                </ul>
            </div>
        </section>
            ...
            <div class="container">
                <div class="catalog-line">
                    <div class="catalog-line__content">
                        <h2 class="g-section-title">О Микрофонах</h2>
                        ...
                        <div class="catalog-link__iner">
                            ...
                            <p class="catalog-text__content">К счастью, при внимательном рассмотрении микрофонная техника и технология оказываются достаточно простыми. Все разнообразие существующих моделей сводится к трём или четырём основным типам микрофонов и четырём типам диаграмм направленности</p>
                        </div><span class="catalog__author">Richie Kotzen</span>
                    </div>
                    <div class="catalog-line__img" style="background-image:url('../../static/img/content/products/product1/big7.jpg')"></div>
                </div>
            </div>
        </section>
        <div class="catalog-view">
            <div class="container">
                <h2 class="g-section-title">Микрофоны</h2>
                <div class="catalog-view-goods"></div>
            </div>
        </div>
        <section class="popular popular-catalog">
            <div class="container">
                <h2 class="g-section-title g-section-title__white">Микрофоны - Популярные бренды</h2>
...
<script src="../../static/js/microphone-catalog.js"></script>
