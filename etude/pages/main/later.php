        ...
        <section class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="later.php">Избранное</a></li>
                </ul>
            </div>
        </section>
        <div class="cart">
            <div class="container">
                <h2 class="g-section-title g-section-title-latter">Избранное</h2>
