        ...
        <section class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="soundequip.php">Звук. Оборудов.</a></li>
                </ul>
            </div>
        </section>
            ...
            <div class="container">
                <div class="catalog-line">
                    <div class="catalog-line__content">
                        <h2 class="g-section-title">О Сабвуферах</h2>
                        <p class="catalog-text">
                            Какие бывают сабвуферы. Они бывают пассивные и активные. Пассивный конструкцией практически не отличается от обыкновенных АС с той лишь разницей, что вместо комплекта динамиков в нём всего один, реже два и более НЧ-динамика. Пассивные сабвуферы дешевле, но гораздо сложнее в настройке. Поэтому наибольшее применение нашли именно активные сабвуферы. Они, как и активные АС, содержат внутри корпуса встроенный усилитель.</p>
                        <div class="catalog-link__iner">
                            <p class="catalog__link">Подробнее..</p>
                            <p class="catalog-text__content">Сабвуферы имеют регулировки уровня и переключатель (в более простых и дешёвых моделях) или регулятор сдвига фазы, низкоамплитудные входы (разъёмы RCA) и высокоамплитудные входы, а иногда и выходы</p>
                        </div>
                    </div>
                    <div class="catalog-line__img" style="background-image:url('../../static/img/content/products/product1/big5.jpg')"></div>
                </div>
            </div>
        </section>
        <div class="catalog-view">
            <div class="container">
                <h2 class="g-section-title">Звуковое Оборудование</h2>
                <div class="catalog-view-goods"></div>
            </div>
        </div>
        <section class="popular popular-catalog">
            <div class="container">
                <h2 class="g-section-title g-section-title__white">Звуковое Оборудование - Популярные бренды</h2>
                <ul class="popular-list">
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.dynacord.com/" target="_blank">Dynacord</a><span class="popular-list__country">Германия</span></li>
                    ...
                    <li class="popular-list__item"><a class="popular-list__link" href="https://kme-sound.com/" target="_blank">K.M.E</a><span class="popular-list__country">Германия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.spectraudio.ru/" target="_blank">spectr audio</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://en.bowaypro.com/" target="_blank">boway</a><span class="popular-list__country">Китай</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://mackie.com/" target="_blank">mackie</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.alesis.com/" target="_blank">alesis</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.soundking.com/" target="_blank">sounking</a><span class="popular-list__country">Китай</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.tcelectronic.com/brand/tcelectronic/home" target="_blank">ts electronic</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://dbxpro.com/en" target="_blank">dbx</a><span class="popular-list__country">США</span></li>
                </ul>
            </div>
        </section>
...
<script src="../../static/js/soundequip.js"></script>
