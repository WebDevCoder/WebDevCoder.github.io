        ...
        <section class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="drums-catalog.php">Ударные</a></li>
                </ul>
            </div>
        </section>
            ...
            <div class="container">
                <div class="catalog-line">
                    <div class="catalog-line__content">
                        <h2 class="g-section-title">О барабанах</h2>
                        <p class="catalog-text">
                            Меня всегда завораживали барабаны. Казалось бы – бочка с мембраной – стучи себе и стучи. Но стоит прикоснуться к мембране руке человека, желающего выплеснуть в мир свои чувства, желания, мысли, как ритм может вызвать и у музыканта и у слушателя абсолютно любое состояние: от транса и страсти, до ненависти и стремления к смерти.</p>
                        <div class="catalog-link__iner">
                            <p class="catalog__link">Подробнее..</p>
                            <p class="catalog-text__content">Конечно, мастерство важно всегда, но игра на барабанах – это тот случай, когда знания – это необходимый минимум. Ключевое слово здесь – минимум. Только овладев знаниями, мастерством игры, нельзя создать истинную мелодию, мистический ритм.</p>
                        </div><span class="catalog__author">Кирилл Аюев</span>
                    </div>
                    <div class="catalog-line__img" style="background-image:url('../../static/img/content/products/product1/big4.jpg')"></div>
                </div>
            </div>
        </section>
        <div class="catalog-view">
            <div class="container">
                <h2 class="g-section-title">Ударные</h2>
                <div class="catalog-view-goods"></div>
            </div>
        </div>
        <section class="popular popular-catalog">
            <div class="container">
                <h2 class="g-section-title g-section-title__white">Ударные - Популярные бренды</h2>
                <ul class="popular-list">
                    <li class="popular-list__item"><a class="popular-list__link" href="https://ru.gewamusic.com/about/history" target="_blank">GEWA</a><span class="popular-list__country">Германия</span></li>
                    ...
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.joubinmahmoudi.com/tama" target="_blank">tama</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://pearldrum.com/products/kits/drumsets/exx-export/" target="_blank">Pearl Export</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.premier-percussion.com/" target="_blank">Premier Cabria</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://mapexdrums.com/us/" target="_blank">Mapex</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.ludwig-drums.com/" target="_blank">Ludwig Rocker</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.tayedrums.com/drum_sets/rockpro/" target="_blank">Taye Rock</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://leonty.by/products/" target="_blank">LEONTY</a><span class="popular-list__country">Россия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://peavey.com/" target="_blank">Peavey </a><span class="popular-list__country">США</span></li>
                </ul>
            </div>
        </section>
...
<script src="../../static/js/drums-catalog.js"></script>
