                ...
                <div class="header-nav">
                    ...
                    <ul class="header-nav__user">
                        <li class="header-nav__item--user">
                            ...
                            </div><a class="header-nav__link-user" href="later.php">избранное</a>
                        </li>
                        <li class="header-nav__item--user">
                            <div class="header-nav__user-icon">
                            ...
                            </div><a class="header-nav__link-user" href="cart.php">корзина</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                <nav class="main-nav">
                    <ul class="main-nav__list">
                        <li class="main-nav__item"><a class="main-nav__link" href="guitars-catalog.php">гитары</a></li>
                        <li class="main-nav__item"><a class="main-nav__link" href="pianos-catalog.php">клавишные</a></li>
                        <li class="main-nav__item"><a class="main-nav__link" href="drums-catalog.php">ударные</a></li>
                        <li class="main-nav__item"><a class="main-nav__link" href="soundequip.php">звуковое оборудование</a></li>
                        <li class="main-nav__item"><a class="main-nav__link" href="commutation.php">коммутация</a></li>
                        <li class="main-nav__item"><a class="main-nav__link" href="microphone.php">микрофоны</a></li>
                    </ul>
                    <ul class="main-nav__list">
        ...
        <section class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="pianos-catalog.php">Клавишные</a></li>
                </ul>
            </div>
        </section>
        <section class="catalog-top-info">
            <div class="container">
                <div class="catalog-line">
                    <div class="catalog-line__content">
                        <h2 class="g-section-title">О роялях</h2>
                        <p class="catalog-text">В наш век сурового материализма, когда сама жизнь порывается заглушить и усыпить лучшие стремления духа,  живая музыка — это мощный порыв, воздвигающий нашу душу. В душе человека, подобно его организму, каждое мгновение убывает частица духовного начала, пополнить которую человек может лишь из мира, лежащего по ту сторону нашего материального бытия.</p>
                        <div class="catalog-link__iner">
                            <p class="catalog__link">Подробнее..</p>
                            <p class="catalog-text__content">Рояль — «магический портал» для путешествий в этот прекрасный мир. Велика заслуга того, кто может (отрешившись от паутины мелочей, опутавших наше существование) установить общение с этим волшебным миром и гармонией настоящей музыки облагородить жизнь</p>
                        </div><span class="catalog__author">Andrew Oliver</span>
                    </div>
                    <div class="catalog-line__img" style="background-image:url('../../static/img/content/products/product1/big3.jpg')"></div>
                </div>
            </div>
        </section>
        <div class="catalog-view">
            <div class="container">
                <h2 class="g-section-title">Клавишные</h2>
                <div class="catalog-view-goods"></div>
            </div>
        </div>
        <section class="popular popular-catalog">
            <div class="container">
                <h2 class="g-section-title g-section-title__white">Клавишные - Популярные бренды</h2>
                <ul class="popular-list">
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.yamaha.com/" target="_blank">YAMAHA</a><span class="popular-list__country">Япония</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.boesendorfer.com/en-us" target="_blank">Boesendorfer</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://eu.steinway.com/ru/" target="_blank">Steinway</a><span class="popular-list__country">Чехия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.fazioli.com/" target="_blank">Fazioli</a><span class="popular-list__country">Япония</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.bechstein.com/ru/" target="_blank">Bechstein</a><span class="popular-list__country">Германия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.bluethnerworld.com/index.php/en/" target="_blank">Blüthner</a><span class="popular-list__country">Германия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.grotrian.de/ru/" target="_blank">Grotrian Steinweg</a><span class="popular-list__country">Германия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://shigerukawai.com/" target="_blank">Shigeru Kawai</a><span class="popular-list__country">Япония</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.schimmel-pianos.de/welcome.html" target="_blank">schimmel piano</a><span class="popular-list__country">Германия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.kohlerandcampbell.com/" target="_blank">Kohler&Campbell</a><span class="popular-list__country">США</span></li>
                </ul>
            </div>
        </section>
...
<script src="../../static/js/pianos-catalog.js"></script>
