        ...
        <section class="breadcrumbs">
          <div class="container">
            <ul class="breadcrumbs-list">
              ...
              <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="cart.php">Корзина</a></li>
            </ul>
          </div>
        </section>
        <div class="cart">
          <div class="container">
            <h2 class="g-section-title g-section-title-cart">Корзина</h2>
            <!-- Загрузка товаров в корзину -->
            <div class="main-cart"></div>
            <div class="main-cart1"></div>
            <div class="main-cart2"></div>
            <div class="main-cart3"></div>
            <div class="main-cart4"></div>
            <div class="main-cart5"></div>
            <div class="main-cart6"></div>
            <div class="main-cart7"></div>
          </div>
        </div>
        <div class="cart-order">
          <div class="container">
            <h2 class="g-section-title order-from-cart">Отправить Заказ</h2>
            <div class="catalog-view__item50 cart-order__item">
              <div class="catalog-view__item-line">
                <input class="g-input g-input-order ename" type="text" placeholder="Ваше имя" id="cart-name">
              </div>
              <div class="catalog-view__item-line">
                <input class="g-input g-input-order email" type="email" placeholder="Ваш e-mail" id="cart-email">
              </div>
              <div class="catalog-view__item-line">
                <input class="g-input g-input-order ephone" type="text" placeholder="Ваш телефон" id="cart-phone">
              </div>
              <div class="content-center">
                <button class="g-btn send-email">Отправить</button>
              </div>
            </div>
          </div>
        </div>
