        ...
        <section class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="commutation.php">Коммутация</a></li>
                </ul>
            </div>
        </section>
            ...
            <div class="container">
                <div class="catalog-line">
                    <div class="catalog-line__content">
                        <h2 class="g-section-title">О Коммутации</h2>
                        <p class="catalog-text">
                            Очевидно, что только высококачественная и удобная коммутация позволяет в полной мере задействовать потенциал звукового (да и любого другого) оборудования. Зачастую некачественные кабели сводят на нет уникальные свойства дорогостоящих устройств и инструментов. Коммутация обеспечивает связь между самыми разнообразными системами, используемыми в современном процессе создания, записи и воспроизведения музыки.</p>
                        <div class="catalog-link__iner">
                            <p class="catalog__link">Подробнее..</p>
                            <p class="catalog-text__content">Немецкий бренд Klotz  более тридцати лет является синонимом высочайшего качества и постоянного развития в сфере профессиональных кабельных мультимедиасистем. Компания Klotz выпускает полную линейку кабельных изделий как для профессиональных музыкантов, так и для амбиционных любителей.</p>
                        </div><span class="catalog__author">ZACH RUDULPHr</span>
                    </div>
                    <div class="catalog-line__img" style="background-image:url('../../static/img/content/products/product1/big6.jpg')"></div>
                </div>
            </div>
        </section>
        <div class="catalog-view">
            <div class="container">
                <h2 class="g-section-title">Коммутация</h2>
                <div class="catalog-view-goods"></div>
            </div>
        </div>
        <section class="popular popular-catalog">
            <div class="container">
                <h2 class="g-section-title g-section-title__white">Коммутация - Популярные бренды</h2>
                <ul class="popular-list">
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.klotz-ais.com/" target="_blank">klotz</a><span class="popular-list__country">Германия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://schulz-kabel.ru/" target="_blank">schulz</a><span class="popular-list__country">Германия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.proel.com/" target="_blank">proel</a><span class="popular-list__country">Италия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.rapcohorizon.com/" target="_blank">horizon</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.switchcraft.com/" target="_blank">switchcraft</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.sommercable.com/" target="_blank">sommercable</a><span class="popular-list__country">Германия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://mrcable.ru/" target="_blank">mrcable</a><span class="popular-list__country">Россия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.quiklok.com/home.php" target="_blank">quiklok</a><span class="popular-list__country">Италия</span></li>
                </ul>
            </div>
        </section>
...
<script src="../../static/js/commutation.js"></script>
