        ...
        <section class="breadcrumbs">
          <div class="container">
            <ul class="breadcrumbs-list">
              ...
              <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="about-us.php">О нас</a></li>
            </ul>
          </div>
        </section>
          ...
          <div class="container">
            ...
            <ul class="about-us-list">
              <li class="about-us__item">
                <h2 class="about-us__title">РАБОТА ПО ВСЕЙ БЕЛАРУСИ</h2>
                <p class="about-us__text">МЫ ИЗУЧАЕМ МИРОВОЙ РЫНОК МУЗЫКАЛЬНЫХ ИНСТРУМЕНТОВ, ВЫЯСНЯЕМ ПОТРЕБНОСТИ БЕЛОРУССКОГО РЫНКА, УСТАНАВЛИВАЕМ И ПОДДЕРЖИВАЕМ КОНТАКТЫ С ИЗВЕСТНЫМИ ПРЕДПРИЯТИЯМИ-ИЗГОТОВИТЕЛЯМИ, СОБИРАЕМ И РАСПРОСТРАНЯЕМ ИНФОРМАЦИЮ О РЕДКИХ МУЗЫКАЛЬНЫХ ИНСТРУМЕНТАХ, А ТАКЖЕ ПРЕДСТАВЛЯЕМ НОВИНКИ СЕЗОНА И ОКАЗЫВАЕМ ПРОФЕССИОНАЛЬНЫЕ КОНСУЛЬТАЦИОННЫЕ УСЛУГИ.</p>
              </li>
              <li class="about-us__item">
                <h2 class="about-us__title">ПРЯМОЙ КОНТАКТ!</h2>
                <p class="about-us__text">МАГАЗИН "ETUDE" ОСУЩЕСТВЛЯЕТ ПРЯМЫЕ ПОСТАВКИ МУЗЫКАЛЬНЫХ ТОВАРОВ БОЛЕЕ 75 ИЗВЕСТНЫХ ТОРГОВЫХ МАРОК ИЗ РОССИИ, ГЕРМАНИИ, ИТАЛИИ, ФРАНЦИИ, ЧЕХИИ, ЯПОНИИ, США.</p>
              </li>
              <li class="about-us__item">
                <h2 class="about-us__title">МУЗЫКАЛЬНЫЙ МИР ТВОЕЙ ДУШИ.</h2>
                <p class="about-us__text">ПОСКОЛЬКУ МНОГИЕ НАШИ КОМПАНИИ-ПОСТАВЩИКИ ИМЕЮТ ПРОИЗВОДСТВА В РАЗНЫХ СТРАНАХ ЕВРОПЕЙСКОГО СОДРУЖЕСТВА, А ТАКЖЕ В ЛАТИНСКОЙ АМЕРИКЕ, В ЮГО-ВОСТОЧНОЙ АЗИИ, В АФРИКЕ И В АВСТРАЛИИ, В ДЕЙСТВИТЕЛЬНОСТИ МЫ ПОСТАВЛЯЕМ МУЗЫКАЛЬНЫЕ ИНСТРУМЕНТЫ И ТОВАРЫ СО ВСЕГО МИРА. ШИРОКИЙ КРУГ ПОСТОЯННЫХ ПОСТАВЩИКОВ ПОЗВОЛЯЕТ НАМ УДОВЛЕТВОРЯТЬ САМЫЕ НЕПРЕДСКАЗУЕМЫЕ ПОЖЕЛАНИЯ НАШИХ КЛИЕНТОВ.</p>
              </li>
              <li class="about-us__item">
                <h2 class="about-us__title">МЫ ПРЕДСТАВЛЯЕМ БРЕНДЫ</h2>
                <p class="about-us__text">ALLEN&HEATH, AUDIX, ATHLETIC, BOSS, CASIO, D'ADDARIO, DB TECHNOLOGIES, DYNAUDIO, EPIPHONE, ERNIE BALL, ESP, EVANS, FENDER, FOCUSRITE, GEWA, GIBSON, HARTKE, HK AUDIO, HOFNER, HOHNER, HUGHES & KETTNER, IBANEZ, KAWAI, LUDWIG, M-AUDIO, NEUMANN, NUMARK, PAISTE, PARTSLAND, PIONEER, PLANET WAVES, PRESONUS, PROAUDIO, RELOOP, ROLAND, SCANDALLI, SEILER, SENNHEISER, SIGMA GUITARS, SINN7, T.C.ELECTRONIC, VIC FIRTH, WELTMEISTER, YAMAHA, ТУЛЬСКАЯ ГАРМОНЬ, ЭМУЗИН И МНОГИХ ДРУГИХ ПРОИЗВОДИТЕЛЕЙ. С ПОЛНЫМ ПЕРЕЧНЕМ НАМИ ПОСТАВЛЯЕМЫХ БРЕНДОВ И ТОВАРОВ ВЫ МОЖЕТЕ ОЗНАКОМИТЬСЯ В РАЗДЕЛЕ “БРЕНДЫ”.</p>
              </li>
            </ul>
          </div>
        </section>
