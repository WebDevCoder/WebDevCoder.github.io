...
<html lang="ru-RU">
  ...
  <body class="catalog-page">
        ...
        <section class="breadcrumbs">
          <div class="container">
            <ul class="breadcrumbs-list">
              ...
              <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="javascript:void(0);">Гитары</a></li>
            </ul>
          </div>
        </section>
          ...
          <div class="container">
            <div class="catalog-line">
              <div class="catalog-line__content">
                <h2 class="g-section-title">О гитарах</h2>
                <p class="catalog-text">Сегодня гитары – одни из самых популярных инструментов во всем мире. Купить гитару стремятся все, кто любит ее красивое, насыщенное, проникновенное звучание. Инструмент используется в самых разных жанрах: классической музыке, джазе, кантри, регги, роке и поп-музыке.</p>
                <div class="catalog-link__iner">
                  <p class="catalog__link">Подробнее..</p>
                  <p class="catalog-text__content">Кроме того, гитара стала любимым инструментом у исполнителей авторской песни, а доступная цена гитары позволяет обучаться игре на ней даже детям. Среди современных гитар в магазине музыкальных инструментов наибольшим спросом пользуются гитары martinez, гитары fender, а также инструменты других известных брендов.</p>
                </div><span class="catalog__author">Benjamin Pall Bruce</span>
              </div>
              <div class="catalog-line__img" style="background-image:url('../../static/img/content/products/product1/big2.jpg')"></div>
            </div>
          </div>
        </section>
        <div class="catalog-view">
            <div class="container">
              <h2 class="g-section-title">Гитары</h2>
              <div class="catalog-view-goods"></div>
          </div>
        </div>
        <section class="popular popular-catalog">
          <div class="container">
            <h2 class="g-section-title g-section-title__white">Гитары - Популярные бренды</h2>
            <ul class="popular-list">
              <li class="popular-list__item"><a class="popular-list__link" href="https://www.taylorguitars.com/" target="_blank">Taylor</a><span class="popular-list__country">США</span></li>
              <li class="popular-list__item"><a class="popular-list__link" href="https://www.takamine.com/welcome" target="_blank">TAKAMINE</a><span class="popular-list__country">Япония</span></li>
              <li class="popular-list__item"><a class="popular-list__link" href="http://strunalschonbach.com/guitars" target="_blank">Strunal</a><span class="popular-list__country">Чехия</span></li>
              <li class="popular-list__item"><a class="popular-list__link" href="http://www.gibson.com/" target="_blank">Gibson</a><span class="popular-list__country">США</span></li>
              <li class="popular-list__item"><a class="popular-list__link" href="https://www.furch.cz/eu-en/" target="_blank">Furch</a><span class="popular-list__country">Чехия</span></li>
              <li class="popular-list__item"><a class="popular-list__link" href="http://www.fendercustomshop.com/guitars/" target="_blank">Fender</a><span class="popular-list__country">США</span></li>
              <li class="popular-list__item"><a class="popular-list__link" href="http://www.landola.fi/" target="_blank">Landola</a><span class="popular-list__country">Финляндия</span></li>
              <li class="popular-list__item"><a class="popular-list__link" href="http://www.ibanez.com/eu/" target="_blank">Ibanez</a><span class="popular-list__country">США</span></li>
              <li class="popular-list__item"><a class="popular-list__link" href="http://www.sutherlandtrading.com/hohner-guitars/" target="_blank">Honher</a><span class="popular-list__country">Германия</span></li>
              <li class="popular-list__item"><a class="popular-list__link" href="http://martinez-guitars.ru/" target="_blank">Martinez</a><span class="popular-list__country">США</span></li>
            </ul>
          </div>
        </section>
    ...
    <script src="../../static/js/guitars-catalog.js"></script>
