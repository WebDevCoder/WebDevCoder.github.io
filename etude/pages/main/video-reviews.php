...
<html lang="ru-RU">
  <head>
    <meta charset="utf-8">
    <title>Видео Обзоры</title><!--[if IE]>
      ...
      <div class="content">
        <section class="breadcrumbs">
          <div class="container">
            <ul class="breadcrumbs-list">
              ...
              <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="javascript:void(0);">Видео Обзоры</a></li>
            </ul>
          </div>
        </section>
        <section class="video-review">
          <div class="container">
            ...
            <div class="video-review__content">
              <div class="video-review__item" id="review3" data-video-id="VE0Vl4qsiqA">
                <div class="video-review__img" style="background-image:url('../../static/img/general/video-bg/slide-3.jpg')">
                  <div class="video-review__play video-start">
                    <svg class="icon icon-play-button ">
                      <use xlink:href="/static/img/svg/symbol/sprite.svg#play-button"></use>
                    </svg>
                ...
                <div class="video-review__info"><span class="video-review__date">17 апреля 2018</span>
                  <p class="video-review__link">Обзор микрофона BM-800</p>
                </div>
              </div>
              <div class="video-review__item" id="review4" data-video-id="YYRxpjXPu3Q">
                <div class="video-review__img" style="background-image:url('../../static/img/general/video-bg/slide-4.jpg')">
                  <div class="video-review__play video-start">
                    <svg class="icon icon-play-button ">
                      <use xlink:href="/static/img/svg/symbol/sprite.svg#play-button"></use>
                    </svg>
                ...
                <div class="video-review__info"><span class="video-review__date">18 апреля 2018</span>
                  <p class="video-review__link">Обзор наушников BEATS SOLO 3</p>
                </div>
              </div>
            </div>
            <div class="video-review__content">
              <div class="video-review__item" id="review5" data-video-id="NO7vtsZsPpM">
                <div class="video-review__img" style="background-image:url('../../static/img/general/video-bg/slide-5.jpg')">
                  <div class="video-review__play video-start">
                    <svg class="icon icon-play-button ">
                      <use xlink:href="/static/img/svg/symbol/sprite.svg#play-button"></use>
                    </svg>
                ...
                <div class="video-review__info"><span class="video-review__date">19 апреля 2018</span>
                  <p class="video-review__link">Микшерный пульт BEHRINGER XENYX Q502USB</p>
                </div>
              </div>
              <div class="video-review__item" id="review6" data-video-id="uMYPEEiAhDU">
                <div class="video-review__img" style="background-image:url('../../static/img/general/video-bg/slide-6.jpg')">
                  <div class="video-review__play video-start">
                    <svg class="icon icon-play-button ">
                      <use xlink:href="/static/img/svg/symbol/sprite.svg#play-button"></use>
                    </svg>
                ...
                <div class="video-review__info"><span class="video-review__date">20 апреля 2018</span>
                  <p class="video-review__link">Барабанная установка YAMAHA GM2F5</p>
                </div>
              </div>
            </div>
          </div>
