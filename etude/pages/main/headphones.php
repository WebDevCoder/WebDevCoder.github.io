        ...
        <section class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="breadcrumbs-list__item"><a class="breadcrumbs-list__link" href="headphones.php">Наушники</a></li>
                </ul>
            </div>
        </section>
            ...
            <div class="container">
                <div class="catalog-line">
                    <div class="catalog-line__content">
                        <h2 class="g-section-title">О Наушниках</h2>
                        <p class="catalog-text">
                            Наушники - «затычки» подходят далеко не всем - форма уха у каждого человека индивидуальна, так что у кого-то наушник сидит крепко, а у кого-то постоянно вываливается, или, что еще хуже, натирает. Обычные «затычки» без мягких насадок недостаточно плотно прилегают к уху. Из-за этого страдает, прежде всего, бас. Да и внешние шумы просачиваются, что особенно важно при прослушивании музыки в шумном метро.
                        </p>
                        <div class="catalog-link__iner">
                            <p class="catalog__link">Подробнее..</p>
                            <p class="catalog-text__content">Отдельные модели наушников имеют дорогие чувствительные мембраны и филигранно исполненные катушки индуктивности, что позволяет им работать от серьезной техники без перегрузок на пользовательской громкости. Но это редкость. Изоляция и достоверность музыки, создаваемой «капельками» на улице и в метро, зависят только от того, насколько плотно пользователь заткнул ими ухо. Если достаточно плотно - то их прямое излучение перекроет внешний шум, а вибрации, переданные на стенки раковины, создадут какие-то низкие частоты и впечатление объема. На многое здесь рассчитывать не приходится. </p>
                        </div><span class="catalog__author">Robib Biezez</span>
                    </div>
                    <div class="catalog-line__img" style="background-image:url('../../static/img/content/products/product1/big8.jpeg')"></div>
                </div>
            </div>
        </section>
        <div class="catalog-view">
            <div class="container">
                <h2 class="g-section-title">Наушники</h2>
                <div class="catalog-view-goods"></div>
            </div>
        </div>
        <section class="popular popular-catalog">
            <div class="container">
                <h2 class="g-section-title g-section-title__white">Наушники - Популярные бренды</h2>
                <ul class="popular-list">
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.samsontech.com/" target="_blank">samson</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://www.shure.com/" target="_blank">shure</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://en-us.sennheiser.com/" target="_blank">sennheiser</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.akg.com/" target="_blank">akg</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://royerlabs.com/" target="_blank">royer</a><span class="popular-list__country">Канада</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="https://www.rcarecords.com/" target="_blank">rca</a><span class="popular-list__country">США</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://en.rode.com/" target="_blank">rode</a><span class="popular-list__country">Австралия</span></li>
                    <li class="popular-list__item"><a class="popular-list__link" href="http://athletic.eu/en/" target="_blank">athletic</a><span class="popular-list__country">Польша</span></li>
                </ul>
            </div>
        </section>
...
<script src="../../static/js/headphones-catalog.js"></script>
